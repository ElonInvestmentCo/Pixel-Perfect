    ...
    <View style={[s.root, { paddingTop: insets.top + 16 }]}>
      ...
      <View style={s.body}>
        <View style={s.iconWrap}>
          <Feather name="tag" size={32} color={BLACK} />
        </View>
        <Text style={s.title}>Sell Gift Card</Text>
        <Text style={s.sub}>Get instant cash for your unused gift cards. Best rates guaranteed.</Text>
        <TouchableOpacity style={s.cta} activeOpacity={0.85}>
          <Text style={s.ctaLabel}>Start Selling</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
