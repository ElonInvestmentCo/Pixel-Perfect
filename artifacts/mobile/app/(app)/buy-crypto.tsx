    ...
    <View style={[s.root, { paddingTop: insets.top + 16 }]}>
      ...
      <View style={s.body}>
        <View style={s.iconWrap}>
          <Feather name="trending-up" size={32} color={BLACK} />
        </View>
        <Text style={s.title}>Buy Crypto</Text>
        <Text style={s.sub}>Buy Bitcoin, Ethereum, Solana, and more with your PayVora balance. Zero fees.</Text>
        <TouchableOpacity style={s.cta} activeOpacity={0.85}>
          <Text style={s.ctaLabel}>Buy Crypto</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
