    ...
    <View style={[s.root, { paddingTop: insets.top + 16 }]}>
      ...
      <View style={s.body}>
        <View style={s.iconWrap}>
          <Feather name="gift" size={32} color={BLACK} />
        </View>
        <Text style={s.title}>Buy Gift Card</Text>
        <Text style={s.sub}>Purchase Amazon, Apple, Google, Netflix, Steam, and 100+ gift cards instantly.</Text>
        <TouchableOpacity style={s.cta} activeOpacity={0.85}>
          <Text style={s.ctaLabel}>Browse Gift Cards</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
