    ...
    <View style={[s.root, { paddingTop: insets.top + 16 }]}>
      ...
      <View style={s.body}>
        <View style={s.iconWrap}>
          <Feather name="trending-down" size={32} color={BLACK} />
        </View>
        <Text style={s.title}>Sell Crypto</Text>
        <Text style={s.sub}>Convert your crypto holdings to cash instantly. Competitive rates, fast settlement.</Text>
        <TouchableOpacity style={s.cta} activeOpacity={0.85}>
          <Text style={s.ctaLabel}>Sell Crypto</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
